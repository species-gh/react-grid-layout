...
var BadOnWidthChangeExample = function (_React$Component) {
	...
	BadOnWidthChangeExample.prototype.render = function render() {
		return _jsx("div", {}, void 0, _jsx("div", {}, void 0, "Current Breakpoint: ", this.state.currentBreakpoint, " (", this.props.cols[this.state.currentBreakpoint], " ", "columns)"), _jsx("div", {}, void 0, "Compaction type:", " ", _lodash2.default.capitalize(this.state.compactType) || "No Compaction"), _jsx("div", {}, void 0, "Current rowHeight: ", this.state.rowHeight), _jsx("button", {
